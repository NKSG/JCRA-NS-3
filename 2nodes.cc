...
class Experiment
{
	public:
		...
		Gnuplot2dDataset Run (const WifiHelper &wifi, const YansWifiPhyHelper &wifiPhy,
				const NqosWifiMacHelper &wifiMac, const YansWifiChannelHelper &wifichannel2, const YansWifiChannelHelper &wifiChannel5);
	private:
...
int main (int argc, char *argv[])
{
	...
	YansWifiChannelHelper wifiChannel5 = YansWifiChannelHelper::Default ();

	// Add Propagation to the channel models
	wifiChannel5.AddPropagationLoss("ns3::FriisPropagationLossModel","Lambda",DoubleValue(0.025));
	wifiChannel2.AddPropagationLoss("ns3::FriisPropagationLossModel","Lambda",DoubleValue(0.125));
	...
	dataset = experiment.Run (wifi, wifiPhy, wifiMac, wifiChannel2,wifiChannel5);
